      ...
      <Card>
        ...
        {obsOpen && (
          <div className="mt-4 grid grid-cols-2 gap-2">
            ...
            {result.observations.commercial_type_detected !== "none" && (
              <div className="flex items-center justify-between py-1.5 px-2 rounded-lg bg-gray-800/50 col-span-2">
                <span className="text-xs text-gray-400">Commercial Type</span>
                <span className="text-xs font-medium text-gray-300">{result.observations.commercial_type_detected}</span>
              </div>
            )}
          </div>
        )}
